$ ->
  ...
  timeline
    ...
    .to(cardA, speed, {delay: speed, z: 0, rotationX: 90, top: "-100%", bottom: "100%", transformOrigin:"center bottom"}, "out")
    .to(cardASecondary, speed, {delay: speed, rotationX: 0, top: "0%"}, "out")
    .set(cardASecondary, {delay: speed*1.5, zIndex: "2"}, "out")
    .addLabel('end')
    .set(cardA, {delay: speed, display: "none"}, "end")
    .to(cardASecondary, speed, {delay: speed, rotationX: -180, transformOrigin: "center top"}, "end")
